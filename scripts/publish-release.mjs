...
//              that platform's assets into the same release.
...
- On Ubuntu, install the \`.deb\` package (it installs the AppArmor profile Ubuntu 24.04 needs). Pick the file matching your CPU: \`x64\` or \`arm64\`.`;
