...
// The macOS app icon (build/icon.icns, build/Assets.car, public/appicons/*.png) is
// generated by scripts/generate-appicon.mjs from the Icon Composer document in design/.
